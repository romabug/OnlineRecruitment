...
sql="Select cid,username,companyname,legal,tel,famous,power,regtime,overtime,powertime,hurry,closed_time,closed_overtime,deal,id,dealman,lastlogin,dealstatus from [01387company] where dealman='"&request.cookies("01387job")("superlogin")&"' or dealman is null"
else
sql="Select cid,username,companyname,legal,tel,famous,power,regtime,overtime,powertime,hurry,closed_time,closed_overtime,deal,id,dealman,lastlogin,dealstatus from [01387company] "
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="table">
  <form name="form2" method="post" action="CompanySearch.asp">
    <tr> 
      <td height="25" colspan="11" background="image/admin_bg_1.gif"> <div align="center"><strong><font color="#FFFFFF">企 
          业 会 员 列 表</font></strong></div></td>
    </tr>
    <tr bgcolor="#E8EEF9"> 
      <td height="28" colspan="11">&nbsp;企业会员搜索： 
        <input name="key" type="text" class="input" id="key2" size="30"> <input name="Submit" type="submit" class="botton" value="搜索">
        （关键字可为：用户名、公司名、法人）</td>
    </tr>
  </form>
  <%if request("Hurry")<>"" then%>
...
%>
  ...
  <form name="form1" method="post" action="">
    <tr bgcolor="#E1E9F7"> 
      <td height="28" colspan="11"><div align="center"><a href="CompanyList.asp?power=4"><font color="#FF0000">重点推荐</font></a>　<a href="CompanyList.asp?power=3"><font color="#006600">VIP会员</font></a>　<a href="CompanyList.asp?power=2"><font color="#0000FF">正式会员</font></a>　<a href="CompanyList.asp?power=1">普通会员</a>　<a href="CompanyList.asp?power=0">待处理会员</a>　<a href="CompanyList.asp?power=">所有会员列表</a>　<a href="CompanyList.asp?closed=1">冻结会员</a> 
        </div></td>
    </tr>
    <tr> 
      <td height="55" bgcolor="#CEDBF2"><div align="center">用户名</div></td>
	  ...
	  <td bgcolor="#CEDBF2"><div align="center">简历</div></td>
    ...
    <tr> 
      ...
      <td width="15%" bgcolor="#f1f3f5"><div align="center"><%=rs(2)%><br>
      ...
      <td width="17%" bgcolor="#f1f3f5"><div align="center"><strong><font face="Geneva, Arial, Helvetica, sans-serif"><%=rs(4)%></font></strong></div></td>
	    ...
	    <td width="17%" bgcolor="#f1f3f5"><div align="center">简历
<%	Call RsName(rs22,"select count(*) from [01387applylist] where cid='20071081644' " ,1,1) %>
          <%=rs22(0)%></div></td>
