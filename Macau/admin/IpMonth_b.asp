...
Set rs=conn.execute("select visittime,count(visittime) from [01387ipcount] where visittime between '"&begindate&"' and '"&enddate&"' group by visittime order by visittime")
dim ip(31)
for m=1 to 31
ip(m)=0
next
...
{
 document.write("<v:shape id='_x0000_s1025' type='#_x0000_t202' alt='' style='position:absolute;left:" + (table_x + all_width + 25) + "px;top:201px;width:60px;height:" + tb_height + "px;z-index:1'>");
 ...
 document.write("<v:rect id='_x0000_s1040' alt='' style='position:absolute;left:" + (table_x + all_width + 80) + "px;top:206px;width:30px;height:20px;z-index:1' fillcolor='" + line_code[i][0] + "'><v:fill color2='" + line_code[i][0] + "' rotate='t' focus='100%' type='gradient'/></v:rect>");
}
}
</script>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="table">
  <form name="form1" method="post" action="IpCount.asp">
    <tr> 
      <td height="25" colspan="2" background="image/admin_bg_1.gif"> <div align="center"><strong><font color="#FFFFFF">首 
          页 IP 统 计</font></strong></div></td>
    </tr>
    <tr bgcolor="#f1f3f5"> 
      <td width="24%" height="30"><div align="right">输入时间： </div></td>
      <td width="76%" height="30"><input name="mydate" type="text" class="input" id="mydate" size="30"> 
        <font color="#FF3300"><strong>(时间格式：2005-9-16)</strong></font></td>
    </tr>
    <tr bgcolor="#f1f3f5"> 
    ...
    <tr bgcolor="#f1f3f5"> 
      <td height="26"><div align="right"><strong><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif">每月首页独立IP统计折线图</font><font face="Verdana, Arial, Helvetica, sans-serif"></font><font face="Verdana, Arial, Helvetica, sans-serif"></font></strong></div></td>
      <td height="26"><strong><font face="Geneva, Arial, Helvetica, sans-serif">　　<a href="IpMonth.asp?myyear=2005&mymonth=9">2005-9</a>　<a href="IpMonth.asp?myyear=2005&mymonth=10">2005-10</a>　<a href="IpMonth.asp?myyear=2005&mymonth=11">2005-11</a>　<a href="IpMonth.asp?myyear=2005&mymonth=12">2005-12</a></font></strong></td>
    </tr>
    <tr bgcolor="#f1f3f5"> 
      <td height="26"><div align="right"><strong><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif">每月IP访问来路饼图分析</font></strong></div></td>
      <td height="26"><strong><font face="Geneva, Arial, Helvetica, sans-serif">　　<a href="IpCircle.asp?myyear=2005&mymonth=9">2005-9</a>　<a href="IpCircle.asp?myyear=2005&mymonth=10">2005-10</a>　</font></strong></td>
    </tr>
  </form>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
dataArray2[0]="#ff0000,1,1,3,日独立IP"
<%for j=1 to 27%>
dataArray2[<%=j%>]=<%=ip(j)%>
<%next%>
<%
