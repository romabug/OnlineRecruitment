...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="table">
  <tr> 
    <td height="25" colspan="11" background="image/admin_bg_1.gif"> <div align="center"><strong><font color="#FFFFFF">个 
        人 会 员 列 表 <a href="http://www.macau69.com/admin_jobs/" target="_blank">（进入推荐投递功能）</a></font></strong></div></td>
  </tr>
  <tr bgcolor="#E8EEF9"> 
    <td height="32" colspan="11"> <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="12">
        <tr> 
          <form name="form2" method="post" action="PersonSearch.asp">
            <td width="72%">个人会员搜索： 
              <input name="key" type="text" class="input" id="key" size="20"> 
              <input name="Submit" type="submit" class="botton" value="搜索"> &nbsp;（关键字可为：用户名、姓名、第一期望职位）</td>
          </form>
          <form name="form3" method="post" action="PersonList.asp">
            <td width="28%"><select name="orderby" class="input">
              ...
              </select> &nbsp; <input name="Submit2" type="submit" class="botton" value="排序"></td>
          </form>
        </tr>
      </table></tr>
  <form name="form1" method="post" action="">
    ...
    <tr bgcolor="#f1f3f5"> 
      ...
      <td width="5%"><div align="center"><strong><font face="Geneva, Arial, Helvetica, sans-serif"><%if orderby=4 then response.write("<font color=red>"&datediff("yyyy",rs(2),date())&"</font>")else response.write(datediff("yyyy",rs(2),date()))%></font></strong></div></td>
      <td width="7%"><div align="center"><font color="#333333" face="Geneva, Arial, Helvetica, sans-serif"><strong><%if orderby=3 then response.write("<font color=red>"&rs(12)&"</font>")else response.write(rs(12))%>年</strong></font></div></td>
      ...
      <td width="17%"><div align="center"><%=rs(4)%></div></td>
      <td width="7%"><div align="center"> 
          <%if rs(7)=true then response.write("<a href='PersonList.asp?orderby=5'><font color=red><u>是</u></font></a>") else response.write("<a href='PersonList.asp?orderby=5'><u>否</u></a>")%>
        </div></td>
      <td width="7%"> <div align="center"> 
...
<%Call PageGo("PersonList","orderby="&orderby&"&")%>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="10"> </td>
  </tr>
