<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="table">
  <form name="form1" method="post" action="IpCount.asp">
    ...
    <tr bgcolor="#f1f3f5"> 
      ...
      <td width="76%" height="30"><input name="mydate" type="text" class="input" id="mydate" size="30" value=<%=date%>> 
	...
	<form name="form2" method="post" action="IpMonth.asp">
    <tr bgcolor="#f1f3f5"> 
      ...
      <td height="26"><strong><font face="Geneva, Arial, Helvetica, sans-serif">　 
	...
	<form name="form3" method="post" action="IpCircle.asp">
    <tr bgcolor="#f1f3f5"> 
      ...
      <td height="26"><strong><font face="Geneva, Arial, Helvetica, sans-serif">　 
        ...
        月 
        <input name="Submit22" type="submit" style="width=80;height=20;font-size=12px" value="查 看">
        </font></strong></td>
    </tr></form>
</table>