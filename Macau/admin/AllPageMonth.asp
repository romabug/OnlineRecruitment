...
Set rs=conn.execute("select visittime,count(visittime) from [01387allpagecount] where visittime between '"&begindate&"' and '"&enddate&"' group by visittime order by visittime")
dim ip(31)
for m=1 to 31
ip(m)=0
next
