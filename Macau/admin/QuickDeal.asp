...
if request("action")="go" then
	...
	call ShowErrorTo("操作成功！","Companyquick.asp?page="&request("page"))
end if
%>
<html>
<head>
  ...
  <form name="form1" method="post" action="QuickDeal.asp?action=go&id=<%=id%>&page=<%=page%>">
    ...
    <tr> 
      <td height="26" colspan="2" bgcolor="#E6E9EC"> <div align="center"> 
          ...
          <input type="button" name="btnPower2" value="返 回" onclick="location.href='CompanyQuick.asp?page=<%=page%>'" style="font-size=12;height=26">
        </div></td>
    </tr>
  </form>
</table>
