...
idsend=Server.HTMLEncode(trim(FileUP.form("id")))
...
sql="select * from [link] where id="&idsend&""
rs.open sql,conn,1,3
response.Write rs("linkname")&"<br>"
...
response.Write ProductImgI&"<br>"
response.Write idsend
'response.Write "我"
