  ...
  <form name="form2" method="post" action="CompanySearch.asp">
    ...
    <tr bgcolor="#E8EEF9"> 
      <td height="28" colspan="11">&nbsp;企业会员搜索： 
        <input name="key" type="text" class="input" id="key" size="30"> <input name="Submit" type="submit" class="botton" value="搜索">
        （关键字可为：用户名、公司名、法人）</td>
    </tr>
  </form>
...
<%if Cint(request.cookies("01387job")("userpower"))>1 then%>
    <tr> 
      <td height="26" colspan="11" bgcolor="#E6E9EC"> <div align="right"> 
          ...
          <input type="button" name="btnDel" value="删除(慎用)" style="font-size=12;height=26" onClick="doSubmit(document.form1,this)">
        </div></td>
    </tr>
	<%end if%>
  </form>
