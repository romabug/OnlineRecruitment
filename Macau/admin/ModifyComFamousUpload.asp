...
<body bgcolor="#E6E9EC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<form name="form1" method="post" action="ModifyComFamousUpload.asp?action=add" enctype="multipart/form-data" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG');return document.MM_returnValue">
<input name="file1" type="file" class="input" id="file1" size="30">
  <input name="filepath" type="hidden" id="filepath" value="../FamousLogo">
