...
<%
Call RsName(rs,"Select a.id,a.reason,a.closed_time,a.closed_overtime,a.myaction,a.userdo,b.jobname,b.jid from [01387ClosedRecord] a inner join [01387joblist] b on a.jid=b.jid order by a.id desc",1,1)
%>
<html>
<head>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="table">
  <form name="form1" method="post" action="">
    <tr> 
      <td height="25" colspan="7" background="image/admin_bg_1.gif"> <div align="center"><strong><font color="#FFFFFF">职 
          位 冻 结 记 录</font></strong></div></td>
    </tr>
    <tr bgcolor="#DFE4F9"> 
      <td height="25"> <div align="center"><font color="#333333"><strong>职位名称</strong></font></div></td>
  ...
  do while not rs.eof%>
    <tr bgcolor="#f1f3f5"> 
      <td width="25%" height="28"><div align="center"><a href="ShowJobDetail.asp?ChkNo=<%=rs(7)%>"><%=rs(6)%></a></div></td>
