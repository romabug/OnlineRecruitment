...
<table width="780" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#111111" bgcolor="#FFFFFF" style="border-collapse: collapse">
  ...
  <tr>    
      <td width="770" height="424" align="center" bgcolor="#F8F7F5"> 
       
        <table width="100%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
          <tr> 
            <td height="134" align="left" bgcolor="#FFFFFF"> <p style="line-height:160%;"><strong><font color="#0033FF" size="3">勞務公司登記</font></strong></p>
              <p style="line-height:160%;">·凡需要招聘內地勞工的勞務公司均可免費發佈招聘資訊、招聘會資訊或其他勞務相關的廣告。<br />
                ·享受更高價值的服務，請聯繫我們。仲介請至電 400 服務熱線：4006756269<br />
                 ·业务咨询邮箱：<a href="mailto:marketing@macau69.com">marketing@macau69.com</a></font> 
              </p>
              <p style="line-height:160%;"><font color="#003399"><strong>第1步：填寫帳號資訊</strong></font><br />
                <font color="#999999">第2步:填寫勞務公司資料</font><br />
              </p>
              </td>
          </tr>
        </table>
		...
		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" style="border-collapse: collapse">
          <tr> 
            ...
            <td width="440" align="left" bgcolor="#F6F9FD"><font color="#FF0000">*</font>( 
              請輸入英文字母、數位或下劃線，長度為6~20個字元，不區分大小寫) </div></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td height="30" align="right" bgcolor="#F6F9FD"><font color="#000000">再次輸入密碼：</font> </div> 
            </td>
