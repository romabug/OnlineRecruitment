...
rs.Open "select username from [01387company] where username='"&request("username")&"'",conn,1,1
...
<table border="1" cellpadding="10" style="border-collapse: collapse" width="100%" height="100%" bordercolor="#CC9900" bgcolor="#FFFFFF">
	<tr>
		...
		<br><br><br><br><br><br><br><br><br><button onfocus="blur();" onclick="window.close();"><img border="0" src="../../person/image/check.gif" align="absmiddle"> 关闭窗口</button></td>
	</tr>
</table>
