  ...
  <tr>
    ...
    <td valign="top" style="BORDER-left: #9DB3C5 1px solid;"><!--#include file="welcome.asp"-->
        <table class='win_update_table' border='0' cellpadding='0' cellspacing='1'>
         <form name="form1" method="post" action="publishjobs_save.asp" onSubmit="return Juge(this)">
            <tr>
...
'>性<span class="win_update_table_td2"> &nbsp;&nbsp;</span>别：</td>
              ...
              <td><font color="#000000">
                <input name="needage" class="input" id="needage" size="10" />
              </font></td>
            </tr>
            <tr>
              ...
              <td><font color="#000000">
                <input name="jobcity" class="input" id="jobcity" size="10" />
...
通过网络<br />
<input onClick="MM_showHideLayers('tip1','','hide');MM_showHideLayers('tip2','','hide');MM_showHideLayers('tip3','','show')" type="radio" value="3" name="fangfa" />
...
'>住房要求：</td>
            ...
            <tr>
              <td class='win_update_table_td2
'>具体要求：</td>
              <td colspan="3"><textarea class="input" id="textarea" name="demand" rows="10" cols="76" style="font-size: 12px"></textarea>
              <br />
...
'>面试须知：</td>
            ...
            <tr>
              <td height="40" colspan="4" align="center" ><button accesskey="K" type="submit" onClick="return check()" class="win_"><img src="../images/203.gif" width="16" height="16" /> 确认修改 </button></td>
            </tr>
          </form>
        </table>
      <br /></td>
