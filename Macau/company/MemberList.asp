...
rs1.open "select uid,degree,birthday,sex,subcatelog,lastlogin,uname,doneyear,province,id from [01387member] where resumestatus='open'   order by lastlogin desc,id desc" ,conn,1,1
%>
...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="jobp_table">
  <tr>
    <td  class='jobp_table_top'>全部简历</td>
  </tr>
  <tr>
    <td align="center">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <form action="" method="post" name="form1" id="form1">
            ...
            <%
					  ...
					  %>
            <tr <%=bg%>>
              <td height="24"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><a href="../Person/viewresume.asp?sid=<%=rs1("id")%>" target="_blank">
      ...
      <table width="100%" height="18" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#D5EDFE" bgcolor="#f0f0f0" class="f12">
          <form method="post" action='MemberList.asp'>
            <tr>
              <td height="30" align="right" bordercolor="#f0f0f0" bgcolor="#FFFFFF">　　
                <%
   If currentpage > 1 Then
      response.write "<a href='MemberList.asp?page="+cstr(1)+"'><font color='#ff0000'>首页</font></a><font color='#333333'><b>-</b></font>"  
      Response.write "<a href='MemberList.asp?page="+Cstr(currentpage-1)+"'><font color='#ff0000'>前页</font></a><font color='#333333'><b>-</b></font>"
   Else
   ...
   If currentpage < Rs1.PageCount Then
      Response.write "<a href='MemberList.asp?page="+Cstr(currentPage+1)+"'><font color='#ff0000'>后页</font></a><font color='#333333'><b>-</b></font>"
      Response.write "<a href='MemberList.asp?page="+Cstr(Rs1.PageCount)+"'><font color='#ff0000'>尾页</font></a>&nbsp;&nbsp;"
   Else
