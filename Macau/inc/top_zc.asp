...
<%if session("typesgo")="" then%>
	您好，还末登录！  <a href="../company/login.asp"><img src="../images/grlgoin.gif" width="63" height="19" border="0" /></a> <a href="../personadmin/login.asp"><img src="../images/qylogin.gif" width="63" height="19" border="0" /></a>
	<%else
	if session("typesgo")="2" then
	%>
	您好，<img src="../images/online_member.gif" /> <font class="wel3"><%=request.cookies("01387job")("personusername")%></font>!  [<a href="default.asp" >求职管理中心</a>] [<a href="logout.asp" >退出登录</a>]  
	<%end if
	if session("typesgo")="1" then%>
	您好，<img src="../images/online_member.gif" /> <font class="wel3"><%=request.cookies("01387job")("companyusername")%></font>!  [<a href="default.asp" >招聘管理中心</a>] [<a href="logout.asp" >退出登录</a>]  
	<%end if
	end if%></li>
	</div>
