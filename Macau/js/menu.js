...
function actionSubMenu(menuitem){
    ...
    if(disp == "block"){
        state = "c";
        menuitem.style.backgroundImage = "url(\"../images/plusclose.gif\")";
        submenu.style.display = "none";
    }else{
        state = "o";
        menuitem.style.backgroundImage = "url(\"../images/plusopen.gif\")";
...
function initSubMenu(menuitem, state){
    ...
    if(state == "o"){
        ...
        menuitem.style.backgroundImage = "url(\"../images/pluopen.gif\")";
        submenu.style.display = "none";
    }
}
-->