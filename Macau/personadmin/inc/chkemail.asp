...
rs.Open "select email from [01387member] where email='"&request("email")&"'",conn,1,1
...
<table border="1" cellpadding="10" style="border-collapse: collapse" width="100%" height="100%" bordercolor="#CC9900" bgcolor="#FFFFFF">
  <tr>
    <td><div align="center">
      ...
      <br>
      <br>
      <br><button onfocus="blur();" onclick="window.close();"><img border="0" src="../image/check.gif" align="absmiddle"> 关闭窗口</button></td>
	</tr>
</table>
</body>
</html>
