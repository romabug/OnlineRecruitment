...
response.Redirect("h_reg_first.asp")
response.End()
end if
%><%'=session("username")%>
            ...
            <td width="97%"><table width="100%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
                <tr> 
                  <td align="left" bgcolor="#FFFFFF"><p><font color="#CCCCCC">&nbsp;&nbsp;&nbsp;第1步：填写帐号信息(已完成)</font> 
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#CCCCCC"><strong><font color="#003399">第2步:填写高级人才简历</font></strong> 
...
<form name="form1" method="post" action="h_reg_second_go_save.asp" onSubmit="return Juge(this)">
  <tr> 
