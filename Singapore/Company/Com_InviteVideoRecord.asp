...
'//查找视频面试收件夹
SQL = "Select * From [pH_Company_VideoOutBox] Where Comid='"&Comid&"' Order By AddDate Desc"
...
function theForm_Submit(id)
{
		...
		if (id=="delvideooutbox")
		{
		  if(confirm('确认彻底删除选定的记录'))
		  {
		    form.target='rslt';
			form.action="Com_Option.asp?param=delvideooutbox";
			openwin();
			form.submit();	   
		   }
...
<title><%= Cls_WebName %> -- 招聘中心 -- 邀请视频面试记录</title>
</head>
<body>
                                  ...
                                  <tr> 
                                    <td bgcolor="#FFFFFF"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                      ...
                                      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="eeeeee">
                                        <tr> 
                                          <td height="25" bgcolor="f5f5f5"><b><font color="#000000">&nbsp;邀请视频面试记录</font></b></td>
                                        </tr>
                                      </table>
                                      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr> 
                                          <td><%= Cls_Page("Com_InviteVideoRecord.asp",PageNo,PCount,RCount) %></td>
                                        </tr>
                                      </table>
                                      <table width="99%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="dddddd">
                                        <tr align="center" bgcolor="f5f5f5"> 
                                          ...
                                          <td width="12%" height="25" bgcolor="f5f5f5">姓 
                                            名</td>
                                          <td width="7%" bgcolor="f5f5f5">性别</td>
                                          <td width="25%" height="25" bgcolor="f5f5f5">应聘职位</td>
                                          <td width="25%" height="25">面试房间</td>
                                          <td height="25">面试时间</td>
                                        </tr>
                                        <% 
For i = 1 to Psize
 ...
 '获取学历
 Edus_Str = ""
 If Edus <> "" Then  Edus_Str = Cls_Edus(Edus)
...
%>
                                        <tr align="center"> 
                                          ...
                                          <td height="25" align="left" bgcolor="#FFFFFF"><%= RoomName %></td>
                                          <td height="25" bgcolor="#FFFFFF"><%= BeginDate %></td>
                                        </tr>
                                        <% 
 Rs.Movenext
Next
Rs.Close
 %>
                            ...
                            <tr> 
							  ...
							  <input type="button" name="delete" value="删除记录" onClick="javascript:theForm_Submit('delvideooutbox')">
                              </td>
                            </tr>
                          </table></td>
                      </tr>
