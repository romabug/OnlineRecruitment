...
Dim Cmd,Rs,Action
Dim JobType,JobClass,BestFlag,DeptId,Require,Edus,Works,Sex,Min_Age,Max_Age
Dim Locus_Area,Locus_City,PhoneKeep,EmailKeep,End_Year,End_Month,End_Day
...
<title><%= Cls_WebName %> -- 招聘中心 -- 编辑职位</title>
</head>
<body>
              ...
              <form action="?action=submit" name="theForm" method="post" onSubmit="return form_check();">
                <tr> 
                  ...
                  color=#ff6600>*</FONT></STRONG> 职位名称：</td>
                              <td height="25" bgcolor="f9f9f9"><input name="jobname" type="text" id="jobname" maxlength="40" style="width:180px" value="<%= Tmp(2,0) %>"></td>
                            </tr>
                            <tr> 
                              <td height="25" align="right">&nbsp;</td>
                  ...
                  color=#ff6600>*</FONT></STRONG> 薪资待遇：</td>
                              <td height="25" bgcolor="f9f9f9"><input name="deal" type="text" style="width:100px" maxlength="4"  value="<%= Tmp(3,0) %>">
                                元/月 ( 默认为0,表示待遇面议 )</td>
                            </tr>
                            <tr> 
                              <td height="25" align="right"><STRONG><FONT 
