...
<table width="950" border="0" cellspacing="0" cellpadding="4">
        ...
        <table width="950" border="0" align="center" cellpadding="2" cellspacing="1">
          ...
          <% 
'------------------------------------------设置固顶-------------------------------
SQL = "Select Top "&Cls_PersonTopNumber&"  I.Perid,I.RealName,I.Sex,I.Edus,I.LastSchool,I.Speciality,I.WorkWill1,B.LastUpdate_Time,i.Photourl,i.ResumeKeep From pH_Person_Base As B,pH_Person_Info As I  Where B.Perid=I.Perid And Len(I.RealName)>0 And (I.ResumeKeep=0 or (i.ResumeKeep=2 And i.Perid Not in (Select Perid From [pH_Person_Keeps] Where Perid=i.Perid And Comid='"&Companyid&"'))) And B.Flag=1  And I.TopAll=1 And DateDiff(d,TopDate,GetDate())>=0  And DateDiff(d,TopEndDate,GetDate())<=0 Order By B.LastUpdate_Time Desc"

Set Rs1 = Conn.Execute(SQL)
i = 1
While Not Rs1.Eof
 Perid = Rs1("Perid")
 ResumeKeep = Rs1("ResumeKeep")
 RealName = Rs1("RealName")
 Sex = Rs1("Sex")
 Edus = Rs1("Edus")
 LastSchool = Rs1("LastSchool")
 Speciality = Rs1("Speciality")
 WorkWill1 = Rs1("WorkWill1")
 LastUpdate_Time = FormatDateTime(Rs1("LastUpdate_Time"),2)
 Photourl = Rs1("Photourl")
 Img_str = ""
 ...
 %>
          <tr <% if i mod 2 = 0 Then %>bgcolor="#f1f1f1"<% End if %>> 
            <td height="25" align="center"><a href="../Person/Per_Resume.asp?Param=<%= Perid %>" target="_blank"><font color="#FF0000"><%= RealName %></font></a> <%= Img_str %></td>
