...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <% If IsArray(Session("Intro")) Then %>
  <tr align="center"> 
    <td height="27" colspan="2">『 <Font color="#ff0000"><u><%= Session("Intro")(0) %></u></Font> 』</td>
  </tr>
  <tr align="center"> 
    <td height="27" colspan="2">欢迎使用<%= Cls_WebName %></td>
  </tr>
  <tr align="center"> 
    <td height="27" colspan="2"><a href="../Intro/Cor_Logout.asp"><u>退出</u></a> 
      <a href="../Intro/User_Center.asp"><u>进入中介专区</u></a></td>
  </tr>
  <% 
	Else
	 %>
  <form name="login" method="post" action="../Public/login.asp"  onSubmit="return login_check();">
    ...
    <tr align="center"> 
      <td height="27" colspan="2"> <input type="submit" name="Submit" value="登 录"> 
        <input type="button" name="Submit2" value="注 册" onClick="location.href='../Intro/Register.asp';"> 
      </td>
    </tr>
    <tr align="center"> 
      <td height="25" colspan="2"><input name="usertype" type="hidden" id="usertype" value="intro">
