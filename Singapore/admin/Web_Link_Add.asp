...
If Action = "add" Then
 ...
 Response.write "<script language=JavaScript>alert('操作成功！');location.href='Web_Link.asp';</script>"
End if
 %>
              ...
              <form name="add" action="?action=add" method="post" onSubmit="return theForm_check()">
                ...
                <tr bgcolor="f5f5f5"> 
                  ...
                  <td height="25"> <input type="submit" name="Submit" value="添 加">
                    <input name="class" type="hidden" id="class" value="1"></td>
                </tr>
              </form>
            </table></td>
</tr>
