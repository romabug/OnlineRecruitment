    ...
    <td height="24"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="5"><img src="../Images/Head/School2_left.jpg" width="5" height="24"></td>
                <td align="center" background="../Images/Head/School2_bg.jpg" style="padding-top:3px;"><a href="../School/" class="k1">校园招聘</a></td>
                <td width="5"><img src="../Images/Head/School2_right.jpg" width="5" height="24"></td>
              </tr>
            </table></td>
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="80"> 
            <table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td align="center" background="../Images/Head/School1_bg.jpg" style="padding-top:3px;"><a href="../School/Info.asp" class="k1"><strong>就业指导</strong></a></td>
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" bgcolor="#6AA306" style="padding-left:6px;padding-top:3px;"> 
      <font color="#FFFFFF"> 
	    <a href="../School/Info_More.asp?Param=38" class="k1">初入职场</a> 
      | <a href="../School/Info_More.asp?Param=39" class="k1">简历设计</a>
	  | <a href="../School/Info_More.asp?Param=40" class="k1">求职案例</a>
	  | <a href="../School/Info_More.asp?Param=41" class="k1">面试宝典</a>
	  </font></td>
  </tr>
</table>
