    ...
    <td height="24"><table width="950" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="5"><img src="../Images/Head/Intro2_left.jpg" width="5" height="24"></td>
                <td align="center" background="../Images/Head/Intro2_bg.jpg" style="padding-top:3px;"><a href="../Intro/" class="k1">中介服务</a></td>
                <td width="5"><img src="../Images/Head/Intro2_right.jpg" width="5" height="24"></td>
              </tr>
            </table></td>
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="80"> 
            <table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td align="center" background="../Images/Head/Intro1_bg.jpg" style="padding-top:3px;"><a href="../Intro/Company.asp" class="k1"><strong>中介公司</strong></a></td>
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" bgcolor="#AA0400" style="padding-left:6px;padding-top:3px;"> 
      ...
      | <a href="../Intro/Cor_Search_Job.asp" class="k1" target="_blank">招聘信息</a></font></td>
  </tr>
</table>
