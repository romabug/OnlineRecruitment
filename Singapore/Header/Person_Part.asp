          ...
          <td width="80"> 
            <table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td align="center" background="../Images/Head/Person1_bg.jpg" style="padding-top:3px;"><a href="../Part/Index_Person.asp" class="k1"><strong>兼职信息</strong></a></td>
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#ff6600"> 
    <td height="25" style="padding-left:6px;padding-top:3px;"> <font color="#FFFFFF">
	    <a href="../Part/Per_Search_New.asp" class="k1" target="_blank">兼职信息</a> 
      | <a href="../Person/Per_PublishPart.asp" class="k1">发布兼职</a> 
	  </font></td>
  </tr>
</table>
