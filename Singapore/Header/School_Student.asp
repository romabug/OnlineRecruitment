          ...
          <td width="80"> 
            <table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td align="center" background="../Images/Head/School1_bg.jpg" style="padding-top:3px;"><a href="../School/Student.asp" class="k1"><strong>学子求职</strong></a></td>
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" bgcolor="#6AA306" style="padding-left:6px;padding-top:3px;"> 
      <font color="#FFFFFF"> <a href="../School/Per_Search_New.asp" target="_blank" class="k1">最新毕业生</a> 
      | <a href="../School/Com_Search_New.asp" target="_blank" class="k1">校园招聘职位</a> 
