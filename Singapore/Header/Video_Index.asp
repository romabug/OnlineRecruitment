...
<td width="90"><a href="../Video/"><img src="../Images/Head/Video_logo.jpg" width="90" height="65" border="0"></a></td>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" style="padding-right:5px;"> <font color="#999999"><a href="../Index.asp">首页</a><img src="../Images/Head/icon1.gif" width="11" height="15" align="absmiddle"><a href="../Person/">个人服务</a><img src="../Images/Head/icon1.gif" width="11" height="15" align="absmiddle"><a href="../Company/">企业服务</a><img src="../Images/Head/icon1.gif" width="11" height="15" align="absmiddle"><a href="../Intro/">人才中介</a><img src="../Images/Head/icon1.gif" width="11" height="15" align="absmiddle"><a href="../Educate/">培训服务</a><img src="../Images/Head/icon1.gif" width="11" height="15" align="absmiddle"><a href="../School/">校园频道</a><img src="../Images/Head/icon1.gif" width="11" height="15" align="absmiddle"><a href="../Info/">资讯中心</a></font></td>
          <td width="80">
...
<table width="85" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td align="center" background="../Images/Head/Video1_bg.jpg" style="padding-top:3px;"><a href="../Video/" class="k1"><strong>视频面试</strong></a></td>
          ...
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="5"><img src="../Images/Head/Video2_left.jpg" width="5" height="24"></td>
                <td align="center" background="../Images/Head/Video2_bg.jpg" style="padding-top:3px;"><a href="../Video/Video_Person.asp" class="k1">视频简历</a></td>
                <td width="5"><img src="../Images/Head/Video2_right.jpg" width="5" height="24"></td>
              </tr>
            </table></td>
          <td width="80"><table width="75" border="0" cellspacing="0" cellpadding="0">
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" bgcolor="#863D70" style="padding-left:6px;padding-top:3px;"> 
      <font color="#FFFFFF"> 
	    <a href="../Video/Video_Room_More.asp" class="k1" target="_blank">面试房间</a> 
      | <a href="../Person/Per_Search_New.asp" class="k1" target="_blank">职位信息</a> 
	  | <a href="../Company/Com_Search_New.asp" class="k1" target="_blank">求职简历</a> 
	  </font></td>
  </tr>
</table>
