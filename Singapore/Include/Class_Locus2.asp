...
function setcity2() { 
switch (document.edit.x_suozaidi.value) { 
case '北京': 
...
document.edit.x_suozaidi1.options.length = 0; 
for(var i = 0; i < labels.length; i++) { 
document.edit.x_suozaidi1.add(document.createElement("OPTION")); 
document.edit.x_suozaidi1.options[i].text=labels[i]; 
document.edit.x_suozaidi1.options[i].value=values[i]; 
if (document.edit.x_suozaidi1.options[i].value=="<%= Locus_City %>")
 {
    document.edit.x_suozaidi1.options[i].selected=true;
 }
 
} 
/*document.edit.x_suozaidi1.selectedIndex = 0; */
} 
</SCRIPT> 
<SELECT NAME="x_suozaidi" OnChange="setcity2()">
...
省(直辖市): 
<SELECT NAME="x_suozaidi1"></SELECT> 
<SCRIPT LANGUAGE="JavaScript"> 
setcity2(); 
</SCRIPT>市(地区、县)