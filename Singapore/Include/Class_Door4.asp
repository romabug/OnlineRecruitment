...
if (document.theForm.door1.options[i].value=="<%= Door_City %>")
 {
    document.theForm.door1.options[i].selected=true;
 }
...
<option value="不限" <% If Door_Area = "不限" Then Response.write "Selected" %>>-不限省份-</option> 
