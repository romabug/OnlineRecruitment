...
function setcity2() { 
switch (document.theForm.x_suozaidi.value) 
{ 
case '不限': 
...
document.theForm.x_suozaidi1.options.length = 0; 
for(var i = 0; i < labels.length; i++) { 
document.theForm.x_suozaidi1.add(document.createElement("OPTION")); 
document.theForm.x_suozaidi1.options[i].text=labels[i]; 
document.theForm.x_suozaidi1.options[i].value=values[i]; 
if (document.theForm.x_suozaidi1.options[i].value=="<%= Locus_City %>")
 {
    document.theForm.x_suozaidi1.options[i].selected=true;
 }
 
} 
/*document.theForm.x_suozaidi1.selectedIndex = 0; */
} 
</SCRIPT> 
<SELECT NAME="x_suozaidi" OnChange="setcity2()" style="width:100px;">
<option value="不限" <% If Locus_Area = "不限" Then Response.write "Selected" %>>-不限省份-</option> 
<option value="北京" <% If Locus_Area = "北京" Then Response.write "Selected" %>>北京 </option>
<option value="天津" <% If Locus_Area = "天津" Then Response.write "Selected" %>>天津 </option>
<option value="上海" <% If Locus_Area = "上海" Then Response.write "Selected" %>>上海 </option>
<option value="重庆" <% If Locus_Area = "重庆" Then Response.write "Selected" %>>重庆 </option>
<option value="广东" <% If Locus_Area = "广东" Then Response.write "Selected" %>>广东 </option>
<option value="江苏" <% If Locus_Area = "江苏" Then Response.write "Selected" %>>江苏 </option>
<option value="浙江" <% If Locus_Area = "浙江" Then Response.write "Selected" %>>浙江 </option>
<option value="福建" <% If Locus_Area = "福建" Then Response.write "Selected" %>>福建 </option>
<option value="湖南" <% If Locus_Area = "湖南" Then Response.write "Selected" %>>湖南 </option>
<option value="湖北" <% If Locus_Area = "湖北" Then Response.write "Selected" %>>湖北 </option>
<option value="山东" <% If Locus_Area = "山东" Then Response.write "Selected" %>>山东 </option>
<option value="辽宁" <% If Locus_Area = "辽宁" Then Response.write "Selected" %>>辽宁 </option>
<option value="吉林" <% If Locus_Area = "吉林" Then Response.write "Selected" %>>吉林 </option>
<option value="云南" <% If Locus_Area = "云南" Then Response.write "Selected" %>>云南 </option>
<option value="四川" <% If Locus_Area = "四川" Then Response.write "Selected" %>>四川</option>
<option value="安徽" <% If Locus_Area = "安徽" Then Response.write "Selected" %>>安徽</option>
<option value="江西" <% If Locus_Area = "江西" Then Response.write "Selected" %>>江西 </option>
<option value="黑龙江" <% If Locus_Area = "黑龙江" Then Response.write "Selected" %>>黑龙江 </option>
<option value="河北" <% If Locus_Area = "河北" Then Response.write "Selected" %>>河北 </option>
<option value="陕西" <% If Locus_Area = "陕西" Then Response.write "Selected" %>>陕西 </option>
<option value="海南" <% If Locus_Area = "海南" Then Response.write "Selected" %>>海南 </option>
<option value="河南" <% If Locus_Area = "河南" Then Response.write "Selected" %>>河南 </option>
<option value="山西" <% If Locus_Area = "山西" Then Response.write "Selected" %>>山西 </option>
<option value="内蒙古" <% If Locus_Area = "内蒙古" Then Response.write "Selected" %>>内蒙古 </option>
<option value="广西" <% If Locus_Area = "广西" Then Response.write "Selected" %>>广西</option>
<option value="贵州" <% If Locus_Area = "贵州" Then Response.write "Selected" %>>贵州 </option>
<option value="宁夏" <% If Locus_Area = "宁夏" Then Response.write "Selected" %>>宁夏 </option>
<option value="青海" <% If Locus_Area = "青海" Then Response.write "Selected" %>>青海</option>
<option value="新疆" <% If Locus_Area = "新疆" Then Response.write "Selected" %>>新疆 </option>
<option value="西藏" <% If Locus_Area = "西藏" Then Response.write "Selected" %>>西藏 </option>
<option value="甘肃" <% If Locus_Area = "甘肃" Then Response.write "Selected" %>>甘肃 </option>
<option value="台湾" <% If Locus_Area = "台湾" Then Response.write "Selected" %>>台湾 </option>
<option value="香港" <% If Locus_Area = "香港" Then Response.write "Selected" %>>香港</option>
<option value="澳门" <% If Locus_Area = "澳门" Then Response.write "Selected" %>>澳门 </option>
<option value="国外" <% If Locus_Area = "国外" Then Response.write "Selected" %>>国外 </option>
</SELECT>
<SELECT NAME="x_suozaidi1" style="width:100px;"></SELECT> 
<SCRIPT LANGUAGE="JavaScript"> 
setcity2(); 
</SCRIPT>
