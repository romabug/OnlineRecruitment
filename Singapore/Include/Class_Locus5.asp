...
function setcity2() { 
switch (document.reg.x_suozaidi.value) { 
case '不限': 
...
document.reg.x_suozaidi1.options.length = 0; 
for(var i = 0; i < labels.length; i++) { 
document.reg.x_suozaidi1.add(document.createElement("OPTION")); 
document.reg.x_suozaidi1.options[i].text=labels[i]; 
document.reg.x_suozaidi1.options[i].value=values[i]; 
} 
document.reg.x_suozaidi1.selectedIndex = 0; 
} 
</SCRIPT>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="25"><SELECT NAME="x_suozaidi" OnChange="setcity2()" style="width:120px;">
  ...
  <tr>
    <td height="25"><SELECT NAME="x_suozaidi1" style="width:120px;">
