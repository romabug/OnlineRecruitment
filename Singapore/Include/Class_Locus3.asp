...
<SELECT NAME="x_suozaidi" OnChange="setcity2()"   style="width:90px;">
<option value="不限" selected>省份不限</option> 
...
<SELECT NAME="x_suozaidi1"  style="width:83px;"></SELECT> 
<SCRIPT LANGUAGE="JavaScript"> 
setcity2(); 
</SCRIPT>
