...
switch (document.edit.huji.value) { 
case '北京': 
...
document.edit.huji1.options.length = 0;

for(var i = 0; i < labels.length; i++) { 
document.edit.huji1.add(document.createElement("OPTION")); 
document.edit.huji1.options[i].text=labels[i]; 
document.edit.huji1.options[i].value=values[i]; 
if (document.edit.huji1.options[i].value=="<%= Door_City %>")
{
 document.edit.huji1.options[i].selected=true;
}

} 
/*document.edit.huji1.selectedIndex = 0; */

} 
</SCRIPT> 
<SELECT NAME="huji" OnChange="setcity()">
 
<option value="北京" <% If Door_Area = "北京" Then Response.write "Selected" %>>北京 </option>
<option value="天津" <% If Door_Area = "天津" Then Response.write "Selected" %>>天津 </option>
<option value="上海" <% If Door_Area = "上海" Then Response.write "Selected" %>>上海 </option>
<option value="重庆" <% If Door_Area = "重庆" Then Response.write "Selected" %>>重庆 </option>
<option value="广东" <% If Door_Area = "广东" Then Response.write "Selected" %>>广东 </option>
<option value="江苏" <% If Door_Area = "江苏" Then Response.write "Selected" %>>江苏 </option>
<option value="浙江" <% If Door_Area = "浙江" Then Response.write "Selected" %>>浙江 </option>
<option value="福建" <% If Door_Area = "福建" Then Response.write "Selected" %>>福建 </option>
<option value="湖南" <% If Door_Area = "湖南" Then Response.write "Selected" %>>湖南 </option>
<option value="湖北" <% If Door_Area = "湖北" Then Response.write "Selected" %>>湖北 </option>
<option value="山东" <% If Door_Area = "山东" Then Response.write "Selected" %>>山东 </option>
<option value="辽宁" <% If Door_Area = "辽宁" Then Response.write "Selected" %>>辽宁 </option>
<option value="吉林" <% If Door_Area = "吉林" Then Response.write "Selected" %>>吉林 </option>
<option value="云南" <% If Door_Area = "云南" Then Response.write "Selected" %>>云南 </option>
<option value="四川" <% If Door_Area = "四川" Then Response.write "Selected" %>>四川</option>
<option value="安徽" <% If Door_Area = "安徽" Then Response.write "Selected" %>>安徽</option>
<option value="江西" <% If Door_Area = "江西" Then Response.write "Selected" %>>江西 </option>
<option value="黑龙江" <% If Door_Area = "黑龙江" Then Response.write "Selected" %>>黑龙江 </option>
<option value="河北" <% If Door_Area = "河北" Then Response.write "Selected" %>>河北 </option>
<option value="陕西" <% If Door_Area = "陕西" Then Response.write "Selected" %>>陕西 </option>
<option value="海南" <% If Door_Area = "海南" Then Response.write "Selected" %>>海南 </option>
<option value="河南" <% If Door_Area = "河南" Then Response.write "Selected" %>>河南 </option>
<option value="山西" <% If Door_Area = "山西" Then Response.write "Selected" %>>山西 </option>
<option value="内蒙古" <% If Door_Area = "内蒙古" Then Response.write "Selected" %>>内蒙古 </option>
<option value="广西" <% If Door_Area = "广西" Then Response.write "Selected" %>>广西</option>
<option value="贵州" <% If Door_Area = "贵州" Then Response.write "Selected" %>>贵州 </option>
<option value="宁夏" <% If Door_Area = "宁夏" Then Response.write "Selected" %>>宁夏 </option>
<option value="青海" <% If Door_Area = "青海" Then Response.write "Selected" %>>青海</option>
<option value="新疆" <% If Door_Area = "新疆" Then Response.write "Selected" %>>新疆 </option>
<option value="西藏" <% If Door_Area = "西藏" Then Response.write "Selected" %>>西藏 </option>
<option value="甘肃" <% If Door_Area = "甘肃" Then Response.write "Selected" %>>甘肃 </option>
<option value="台湾" <% If Door_Area = "台湾" Then Response.write "Selected" %>>台湾 </option>
<option value="香港" <% If Door_Area = "香港" Then Response.write "Selected" %>>香港</option>
<option value="澳门" <% If Door_Area = "澳门" Then Response.write "Selected" %>>澳门 </option>
<option value="国外" <% If Door_Area = "国外" Then Response.write "Selected" %>>国外 </option>
</SELECT>
省(直辖市): 
<SELECT NAME="huji1"></SELECT> 
