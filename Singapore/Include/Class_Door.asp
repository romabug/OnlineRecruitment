...
function setcity() { 
switch (document.reg.huji.value) { 
case '北京': 
...
document.reg.huji1.options.length = 0; 
for(var i = 0; i < labels.length; i++) { 
document.reg.huji1.add(document.createElement("OPTION")); 
document.reg.huji1.options[i].text=labels[i]; 
document.reg.huji1.options[i].value=values[i]; 
} 
document.reg.huji1.selectedIndex = 0; 
} 
</SCRIPT> 
