...
<title><%= Cls_WebName %> -- 搜索自荐人才</title>
...
<table width="950" border="0" cellspacing="0" cellpadding="4">
        ...
        <table width="950" border="0" align="center" cellpadding="2" cellspacing="1">
          <tr align="center" bgcolor="#4273B2"> 
            <td width="11%" height="25"><font color="#FFFFFF"><strong>姓 名</strong></font></td>
            <td width="6%" height="25"><font color="#FFFFFF"><strong>性别</strong></font></td>
            <td width="7%"><font color="#FFFFFF"><strong>学历</strong></font></td>
            <td width="24%" height="25"><font color="#FFFFFF"><strong>求职意向</strong></font></td>
